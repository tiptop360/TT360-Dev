...
- [x] ~~Assign an age range to each kids product~~ — **done 2026-05-28 via `metafieldsSet`**, 15/15 succeeded. Distribution: All ages (13), 2-6 years (1: kids-wax-crayons-uae — chunky toddler grip), 7-12 years (1: kids-dual-tip-markers-uae — 5+ with choking risk under-5). Skipped 4 non-kids products: ai-voice-recorder, magnetic-gym-bag-uae, digital-gift-card-uae, gift-wrap-1. Spot-fix any wrong call: Products → product → Metafields → Age Range.
